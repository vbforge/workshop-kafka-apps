...
public class ProducerService {
    ...
    public ProducerResponse send(String content, String failureMode, int succeedOnAttempt) {
        if (failureMode == null || failureMode.isBlank()) failureMode = "eventually-succeed";
        ...
        log.info(">>> [PRODUCER] Sending id={} failureMode={} succeedOnAttempt={}",
                message.getId(), failureMode, succeedOnAttempt);

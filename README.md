...
| 5 | [kafka-order-logger](kafka-order-logger)                               | Idempotent producer, exactly-once semantics, `ErrorHandlingDeserializer`, offset commit to DB                                                                                                                                               |
| 6 | [kafka-shopping-cart](kafka-shopping-cart)                             | Compacted topics, event sourcing, state reconstruction, snapshotting                                                                                                                                                                        |
| 7 | [kafka-dlq-visualizer](kafka-dlq-visualizer)                           | `@RetryableTopic`, poison pills, manual DLQ replay, dead letter queue patterns                                                                                                                                                              |

...
| 5 | [kafka-06-producer-consumer-masterclass](kafka-06-producer-consumer-masterclass/README.md)     | Comprehensive Spring Boot + Kafka masterclass covering every producer/consumer pattern used in real projects: sync, async, keyed, filtered, transactional, error-handling, and manual offset control. (Spring Boot)                 |

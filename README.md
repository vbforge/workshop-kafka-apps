...
| 3 | [kafka-java-code-beginners](kafka-java-code-beginners/README.md) | Producers and Consumers using Java, showcasing various patterns including simple messaging, callbacks, key-based partitioning, graceful shutdown, and cooperative rebalancing. Configured with Kafka in Docker (+ Conduktor UI) |
